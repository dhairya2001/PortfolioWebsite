      ...
      <VStack spacing={4} align="stretch">
        <Box h={isMobile ? "400px" : "150px"}>
          <Grid
            ...
            templateRows={isMobile ? "repeat(2,1fr)" : "repeat(2,1fr)"}
            gap={2}
          >
            ...
            <GridItem colSpan={isMobile ? 4 : 3} h="40" justifyContent="left">
              <Text as="b" fontSize="50px">
                Hey! 👋 I&apos;m{" "}
                <span style={{ color: "#905fff" }}>Dhairya</span>
              </Text>
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                />
                <Text as="b" style={{ marginRight: "10px" }}>
                  {" "}
                  &nbsp; {ExampleComponent()}
                </Text>
              </div>
        ...
        <Box style={{ marginTop: "100px", textAlign: "center" }} id="about">
          ...
          <Text fontSize="25px">
            {/* style={{color:"#a6a2bf"}} */}
            I&apos;m a skilled software developer with experience in C/C++,
            Python, JavaScript, and Java, with profound knowledge in databases
            like MySQL, PostgreSQL and MongoDB. I&apos;m Skilled in frameworks
            and tools such as NextJS, ReactJS, and Nodejs. Let&apos;s work
