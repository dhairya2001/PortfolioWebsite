  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: colorMode === "light" ? "#7faec5" : "#2d3748",
        borderColor: colorMode === "light" ? "black" : "azure",
      }}
    ...
    >
      ...
      <Text textAlign="center" fontWeight="bold" fontSize="40px">
        CONTACT
      </Text>
      <Formik
        ...
        onSubmit={(values, actions) => {
          axios
            .post("https://sheetdb.io/api/v1/vk5t33hw8q8wx", {
              name: values.name,
              email: values.email,
